...
void ScaleRowDown2_Any_NEON(const uint8_t* src_ptr,
                            ...
                            uint8_t* dst_ptr,
                            int dst_width);
void ScaleRowDown2_Any_SME(const uint8_t* src_ptr,
                           ptrdiff_t src_stride,
                           uint8_t* dst_ptr,
                           int dst_width);
void ScaleRowDown2Linear_Any_NEON(const uint8_t* src_ptr,
                                  ...
                                  uint8_t* dst_ptr,
                                  int dst_width);
void ScaleRowDown2Linear_Any_SME(const uint8_t* src_ptr,
                                 ptrdiff_t src_stride,
                                 uint8_t* dst_ptr,
                                 int dst_width);
void ScaleRowDown2Box_Any_NEON(const uint8_t* src_ptr,
                               ...
                               uint8_t* dst_ptr,
                               int dst_width);
void ScaleRowDown2Box_Any_SME(const uint8_t* src_ptr,
                              ptrdiff_t src_stride,
                              uint8_t* dst_ptr,
                              int dst_width);
