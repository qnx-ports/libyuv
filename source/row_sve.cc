...
// correctly: if there is a single element remaining then we want to load one Y
// element but two UV elements.
#define READNV_SVE                               \
  "ld1b       {z0.h}, p1/z, [%[src_y]]       \n" \
...
static void NVToARGBRow_SVE2(const uint8_t* src_y,
