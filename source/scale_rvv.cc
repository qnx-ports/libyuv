...
void ScaleRowDown2Box_RVV(const uint8_t* src_ptr,
  ...
  do {
    ...
    vuint8m4_t v_s1 = __riscv_vget_v_u8m4x2_u8m4(v_t, 1);
    vuint8m4_t v_t0 = __riscv_vget_v_u8m4x2_u8m4(v_src1, 0);
    vuint8m4_t v_t1 = __riscv_vget_v_u8m4x2_u8m4(v_src1, 1);
...
void ScaleRowDown4_RVV(const uint8_t* src_ptr,
  ...
  do {
    ...
    vuint8m2_t v_s2 = __riscv_vget_v_u8m2x2_u8m2(v_s, 2);
...
void ScaleRowDown4Box_RVV(const uint8_t* src_ptr,
  ...
  do {
    ...
    size_t vl = __riscv_vsetvl_e8m2(w) vuint8m2x4_t v_s =
        __riscv_vlseg4e8_v_u8m2x4(src_ptr, vl);
...
void ScaleRowDown34_0_Box_RVV(const uint8_t* src_ptr,
  ...
  do {
    ...
    if (src_stride == 0) {
      ...
      vuint8m2x4_t v_s = __riscv_vlseg4e8_v_u8m2x4(t, vl);
      vuint8m2_t v_t0 = __riscv_vget_v_u8m2x4_u8m2(v_t, 0);
      vuint8m2_t v_t1 = __riscv_vget_v_u8m2x4_u8m2(v_t, 1);
      vuint8m2_t v_t2 = __riscv_vget_v_u8m2x4_u8m2(v_t, 2);
      vuint8m2_t v_t3 = __riscv_vget_v_u8m2x4_u8m2(v_t, 3);
    ...
    v_u1_u16 = __riscv_vwaddu_vx_u16m4(v_u1, 0, __RISCV_VXRM_RNU, vl);
...
void ScaleRowDown38_RVV(const uint8_t* src_ptr,
  ...
  do {
    ...
    vuint8m1x3_t v_dst = __riscv_vcreate_v_u8m1x3(v_0, v_3, v_6);
...
void ScaleUVRowDown2Box_RVV(const uint8_t* src_uv,
  ...
  do {
    ...
    vuint8m2_t v_u0_row0 = __riscv_vget_v_u8m2x2_u8m2(v_s, 0);
    vuint8m2_t v_v0_row0 = __riscv_vget_v_u8m2x2_u8m2(v_s, 1);
    vuint8m2_t v_u1_row0 = __riscv_vget_v_u8m2x2_u8m2(v_s, 2);
    vuint8m2_t v_v1_row0 = __riscv_vget_v_u8m2x2_u8m2(v_s, 3);
    vuint8m2x4_t v_t = __riscv_vlseg4e8_v_u8m2x4(src_uv_row1, vl);
    vuint8m2_t v_u0_row1 = __riscv_vget_v_u8m2x2_u8m2(v_t, 0);
    vuint8m2_t v_v0_row1 = __riscv_vget_v_u8m2x2_u8m2(v_t, 1);
    vuint8m2_t v_u1_row1 = __riscv_vget_v_u8m2x2_u8m2(v_t, 2);
    vuint8m2_t v_v1_row1 = __riscv_vget_v_u8m2x2_u8m2(v_t, 3);
...
void ScaleUVRowUp2_Linear_RVV(const uint8_t* src_ptr,
  ...
  while (work_width > 0) {
    ...
    v_dst = __riscv_vcreate_v_u16m2x2(v_dst_even, v_dst_odd);
    __riscv_vsseg2e16_v_u16m2x2(work_dst_ptr, v_dst, vl / 2);
