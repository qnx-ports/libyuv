  ...
  switch (mode) {
    ...
    case kRotate90:
      RotatePlane90(src_u, src_stride_u, dst_y, dst_stride_y, halfwidth,
                    height);
      ret = ScalePlane(dst_y, dst_stride_y, height, halfwidth, dst_u,
      ...
      RotatePlane90(src_v, src_stride_v, dst_y, dst_stride_y, halfwidth,
                    height);
      ret = ScalePlane(dst_y, dst_stride_y, height, halfwidth, dst_v,
  ...
  switch (mode) {
    ...
    case kRotate90:
      RotatePlane90_16(src_u, src_stride_u, dst_y, dst_stride_y, halfwidth,
                       height);
      ret = ScalePlane_16(dst_y, dst_stride_y, height, halfwidth, dst_u,
                          dst_stride_u, halfheight, width, kFilterBilinear);
      if (ret != 0) {
        return ret;
      }
      RotatePlane90_16(src_v, src_stride_v, dst_y, dst_stride_y, halfwidth,
                       height);
      ret = ScalePlane_16(dst_y, dst_stride_y, height, halfwidth, dst_v,
                          dst_stride_v, halfheight, width, kFilterLinear);
      if (ret != 0) {
        return ret;
      }
