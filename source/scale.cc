...
int I420Scale(const uint8_t* src_y,
  ...
  if (ScalePlane(src_y, src_stride_y, src_width, src_height, dst_y,
...
int I420Scale_16(const uint16_t* src_y,
  ...
  if (ScalePlane_16(src_y, src_stride_y, src_width, src_height, dst_y,
                    dst_stride_y, dst_width, dst_height, filtering) ||
...
int I420Scale_12(const uint16_t* src_y,
  ...
  if (ScalePlane_12(src_y, src_stride_y, src_width, src_height, dst_y,
                    dst_stride_y, dst_width, dst_height, filtering) ||
...
int I444Scale(const uint8_t* src_y,
  ...
  if (ScalePlane(src_y, src_stride_y, src_width, src_height, dst_y,
                 dst_stride_y, dst_width, dst_height, filtering) ||
      ScalePlane(src_u, src_stride_u, src_width, src_height, dst_u,
                 dst_stride_u, dst_width, dst_height, filtering) ||
      ScalePlane(src_v, src_stride_v, src_width, src_height, dst_v,
...
int I444Scale_16(const uint16_t* src_y,
  ...
  if (ScalePlane_16(src_y, src_stride_y, src_width, src_height, dst_y,
                    dst_stride_y, dst_width, dst_height, filtering) ||
      ScalePlane_16(src_u, src_stride_u, src_width, src_height, dst_u,
                    dst_stride_u, dst_width, dst_height, filtering) ||
      ScalePlane_16(src_v, src_stride_v, src_width, src_height, dst_v,
                    dst_stride_v, dst_width, dst_height, filtering)) {
    return -1;
  }
  return 0;
...
int I444Scale_12(const uint16_t* src_y,
  ...
  if (ScalePlane_12(src_y, src_stride_y, src_width, src_height, dst_y,
                    dst_stride_y, dst_width, dst_height, filtering) ||
      ScalePlane_12(src_u, src_stride_u, src_width, src_height, dst_u,
                    dst_stride_u, dst_width, dst_height, filtering) ||
      ScalePlane_12(src_v, src_stride_v, src_width, src_height, dst_v,
                    dst_stride_v, dst_width, dst_height, filtering)) {
    return -1;
  }
  return 0;
