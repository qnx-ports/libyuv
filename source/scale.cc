...
int I420Scale(const uint8_t* src_y,
  ...
  ret = ScalePlane(src_y, src_stride_y, src_width, src_height, dst_y,
                   dst_stride_y, dst_width, dst_height, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane(src_u, src_stride_u, src_halfwidth, src_halfheight, dst_u,
                   dst_stride_u, dst_halfwidth, dst_halfheight, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane(src_v, src_stride_v, src_halfwidth, src_halfheight, dst_v,
...
int I420Scale_16(const uint16_t* src_y,
  ...
  ret = ScalePlane_16(src_y, src_stride_y, src_width, src_height, dst_y,
                      dst_stride_y, dst_width, dst_height, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane_16(src_u, src_stride_u, src_halfwidth, src_halfheight, dst_u,
                      dst_stride_u, dst_halfwidth, dst_halfheight, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane_16(src_v, src_stride_v, src_halfwidth, src_halfheight, dst_v,
                      dst_stride_v, dst_halfwidth, dst_halfheight, filtering);
  return ret;
}
...
int I420Scale_12(const uint16_t* src_y,
  ...
  ret = ScalePlane_12(src_y, src_stride_y, src_width, src_height, dst_y,
                      dst_stride_y, dst_width, dst_height, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane_12(src_u, src_stride_u, src_halfwidth, src_halfheight, dst_u,
                      dst_stride_u, dst_halfwidth, dst_halfheight, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane_12(src_v, src_stride_v, src_halfwidth, src_halfheight, dst_v,
                      dst_stride_v, dst_halfwidth, dst_halfheight, filtering);
  return ret;
}
...
int I444Scale(const uint8_t* src_y,
  ...
  ret = ScalePlane(src_u, src_stride_u, src_width, src_height, dst_u,
                   dst_stride_u, dst_width, dst_height, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane(src_v, src_stride_v, src_width, src_height, dst_v,
...
int I444Scale_16(const uint16_t* src_y,
  ...
  ret = ScalePlane_16(src_u, src_stride_u, src_width, src_height, dst_u,
                      dst_stride_u, dst_width, dst_height, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane_16(src_v, src_stride_v, src_width, src_height, dst_v,
                      dst_stride_v, dst_width, dst_height, filtering);
  return ret;
}
...
int I444Scale_12(const uint16_t* src_y,
  ...
  ret = ScalePlane_12(src_u, src_stride_u, src_width, src_height, dst_u,
                      dst_stride_u, dst_width, dst_height, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane_12(src_v, src_stride_v, src_width, src_height, dst_v,
                      dst_stride_v, dst_width, dst_height, filtering);
  return ret;
}
...
int I422Scale(const uint8_t* src_y,
  ...
  ret = ScalePlane(src_u, src_stride_u, src_halfwidth, src_height, dst_u,
                   dst_stride_u, dst_halfwidth, dst_height, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane(src_v, src_stride_v, src_halfwidth, src_height, dst_v,
...
int I422Scale_16(const uint16_t* src_y,
  ...
  ret = ScalePlane_16(src_u, src_stride_u, src_halfwidth, src_height, dst_u,
                      dst_stride_u, dst_halfwidth, dst_height, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane_16(src_v, src_stride_v, src_halfwidth, src_height, dst_v,
                      dst_stride_v, dst_halfwidth, dst_height, filtering);
  return ret;
}
...
int I422Scale_12(const uint16_t* src_y,
  ...
  ret = ScalePlane_12(src_u, src_stride_u, src_halfwidth, src_height, dst_u,
                      dst_stride_u, dst_halfwidth, dst_height, filtering);
  if (ret != 0) {
    return ret;
  }
  ret = ScalePlane_12(src_v, src_stride_v, src_halfwidth, src_height, dst_v,
                      dst_stride_v, dst_halfwidth, dst_height, filtering);
  return ret;
}
...
int NV12Scale(const uint8_t* src_y,
  ...
  ret = UVScale(src_uv, src_stride_uv, src_halfwidth, src_halfheight, dst_uv,
