...
int I010ToNV12(const uint16_t* src_y,
  ...
  uint8_t* temp_u = (uint8_t*) malloc(((width + 1) / 2) * ((height + 1) / 2));
  uint8_t* temp_v = (uint8_t*) malloc(((width + 1) / 2) * ((height + 1) / 2));
  ...
  int r = I010ToI420(src_y, src_stride_y, src_u, src_stride_u, src_v, src_stride_v,
