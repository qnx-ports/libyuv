...
void ScaleRowDown4Box_NEON(const uint8_t* src_ptr,
  ...
  asm("1:                                        \n"
      ...
      : "+r"(src_ptr),    // %0
        ...
        "+r"(src_ptr3)    // %5
      :
      : "memory", "cc", "q0", "q1", "q2", "q3", "memory", "cc");
}
...
void ScaleRowDown34_0_Box_NEON(const uint8_t* src_ptr,
  ...
  asm("vmov.u8     d24, #3                       \n"
      ...
      : "+r"(src_ptr),    // %0
        ...
        "+r"(src_stride)  // %3
      :
      : "memory", "cc", "q0", "q1", "q2", "q3", "q8", "q9", "q10", "q11", "d24",
        "memory", "cc");
}
...
void OMITFP ScaleRowDown38_3_Box_NEON(const uint8_t* src_ptr,
  ...
  asm("vld1.16     {q13}, [%5]                   \n"
      ...
      : "r"(&kMult38_Div6),  // %5
        "r"(&kShuf38_2),     // %6
        "r"(&kMult38_Div9)   // %7
      : "memory", "cc", "q0", "q1", "q2", "q3", "q8", "q9", "q13", "q14", "q15",
        "memory", "cc");
}
...
void ScaleRowDown38_2_Box_NEON(const uint8_t* src_ptr,
  ...
  asm("vld1.16     {q13}, [%4]                   \n"
      ...
      : "r"(&kMult38_Div6),  // %4
        "r"(&kShuf38_2)      // %5
      : "memory", "cc", "q0", "q1", "q2", "q3", "q13", "q14", "memory", "cc");
}
...
void ScaleFilterRows_NEON(uint8_t* dst_ptr,
  ...
  asm("cmp         %4, #0                        \n"
      ...
      :
      : "memory", "cc", "q0", "q1", "d4", "d5", "q13", "q14", "memory", "cc");
}
