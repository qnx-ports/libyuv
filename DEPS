...
vars = {
  ...
  'chromium_revision': '56e1ad996a26866928b7737b8e7500df83a9c0cc',
...
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '73bce3281598ad755a9ba3246125fc94f8faa5a7',
  ...
  # iOS deps:
  'src/ios': {
    'url': Var('chromium_git') + '/chromium/src/ios' + '@' + 'b89c07f8fbf00f40b61fbbb74c2ba3994a0c89dc',
